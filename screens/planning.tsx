...
import { BarChartReport, TotalWeightContainer } from '../components/reportContainer';

const PlanningScreen = ({route}: {route: any}) => {
        ...
        <MainContainer>
            ...
            {dataProcess== true ? (
                ...
                <View>
                    ...
                    <BarChartReport barData={BarData} />

                    <TotalWeightContainer totalWeight={totalWeight}/>
